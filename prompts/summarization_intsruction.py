summarization_prompt_library = {
    ...
    "analyze_income_stmt": {
        ...
        "input_file_map": {
            ...
            "sec_filings/sec_10k_section_7.txt": "section_text"
        },
        "raw_data_needed": [
    ...
    "risk_assessment": {
        ...
        "input_file_map": {
            ...
            "sec_filings/sec_10k_section_1a.txt": "risk_factors"
        },
        "raw_data_needed": [
    ...
    "analyze_company_description": {
        ...
        "input_file_map": {
            "company_profile.json": "company_name",
            "sec_filings/sec_10k_section_1.txt": "business_summary",
            "sec_filings/sec_10k_section_7.txt": "section_7"
        },
        "raw_data_needed": [
